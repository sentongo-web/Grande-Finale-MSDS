...
def preprocess_data(data):
    ...
    processed = load_data()  # Reuse dashboard preprocessing
    
    # Additional modeling-specific processing
    to_drop = ['CIF_Value_UGX', 'Invoice_Amount', 'Value_per_kg', 
              'Value_per_unit', 'FOB_per_kg', 'Freight_per_kg', 
              'Insurance_per_kg']
...
numeric_features = [
    ...
    'Freight_USD', 'Insurance_USD', 'CIF_Value_USD', 'Tax_Rate',
    'Tax_Load', 'Import_Duration', 'Value_Density'
]
